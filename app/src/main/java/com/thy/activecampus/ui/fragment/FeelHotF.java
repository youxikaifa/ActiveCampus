...
import com.thy.activecampus.ui.activity.FeelDetailA;
...
public class FeelHotF extends Fragment implements SwipeRefreshLayout.OnRefreshListener {

    public final static LabelReqImpl request = LabelReqImpl.getInstance();
    public final static String SCHOOL = "all";
